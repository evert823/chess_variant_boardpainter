...
mychuboardpainter.load_file("./shogi_variants/positions/taikyoku_initial_position.json")
mychuboardpainter.create_board_image_and_save("./shogi_variants/boardimages/taikyoku_initial_position_set2.png")
